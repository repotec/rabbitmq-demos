...
public class ConsumerExceptionWithoutDLXProducerApplication implements CommandLineRunner {
	public static void main(String[] args) throws Exception {
		SpringApplication.run(ConsumerExceptionWithoutDLXProducerApplication.class, args);
	}
