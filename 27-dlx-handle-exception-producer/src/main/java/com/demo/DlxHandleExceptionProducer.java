...
public class DlxHandleExceptionProducer implements CommandLineRunner {
	public static void main(String[] args) throws Exception {
		SpringApplication.run(DlxHandleExceptionProducer.class, args);
	}
	...
	public void run(String... args) throws Exception {
		for (int i = 0; i < 5; i++) {
			...
			// this line is going to cause an DLX by throw AmqpRejectAndDontRequeueException in consumer
